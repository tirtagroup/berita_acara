...
class Detail_Kasus_Controller extends Controller
{
  public function index()
  {
     ...
     $data = Ms_Kasus::all();
      ...
      {
        return view ('berita_acara.ms_detail_kasus', compact('data', 'user') );
      }
  ...
  public function store(Request $request)
{
    $validator = Validator::make($request->all(), [
        'description' => 'required|unique:ms_kasus,description,' . $request->id,
        'ms_kasus_code' => 'required',
        'ms_kasus_head1' => 'required',
        'rec_usercreated' => 'required'
    ]);
    ...
    $ms_head_kasus = Ms_Kasus::updateOrCreate(
        ['id' => $request->id],
        [
