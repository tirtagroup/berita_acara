    ...
    */
    ...
    'connections' => [
        ...
        'mysql_new' => [
            ...
            'database' => env('DB_DATABASE_NEW', 'tirt3038_ERP'),
            'username' => env('DB_USERNAME_NEW', 'tirt3038_HR_Management'),
            'password' => env('DB_PASSWORD_NEW', 'pfind@sqlserver'),
        ...
        'mysql' => [
            ...
            'password' => env('DB_PASSWORD', 'kV*f9VGxZZKxamk!'),
