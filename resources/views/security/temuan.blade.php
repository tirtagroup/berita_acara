...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Report Temuan</h4>
  ...
  <div class="col">
                ...
                <div class="">
                  <div class="pure-g">
                    ...
                    <table class="table table-bordered" id="journal-entrees">
                          ...
                          <tr class='entree-row'>
                            <td>
                                <input name="nama_temuan[]" class="form-control"  type="text"   required/>
                            </td>
                            <td>
                                <input name="nama_penemu[]" class="form-control"  type="text"   required/>
                            </td>
                            <td>
                                <input  name="tanggal_ditemukan[]" class="form-control"  type="date"   required/>
                            </td>
                          </tr>
                          <tr class="button-row">
    ...
    <script>
        ...
        function newRow() {
          ...
          var tr_e = "</tr>";
          var account_in_s = '<td><input name="nama_temuan[]" class="form-control"  type="text"   required/></td> ';
          var select_account = $("#select_account").html();
          var row_insert = $("#row_insert").html();
          var select_account_e = '</select></td>';
          var credit_in = '<td><input  onkeyUp="update_in(\'credit_in\');" name="tanggal_ditemukan[]" class="form-control"  type="date"  ></td>';
          var debit_in = '<td><input   onkeyUp="update_in(\'debit_in\');" name="nama_penemu[]" class="form-control"  type="text"  ></td>';
        //   var memo_in = '<td><select name ="hasil_interview[]" class="form-control"> <option value = "Lulus">Lulus</option><option value = "Tidak Lulus">Tidak Lulus</option><option value = "Pending">Pending</option> ';
          ...
          $(".row-body").append(tr_s+account_in_s+select_account+select_account_e+debit_in+credit_in+remove_button+tr_e+tr_btn_s+add_button+tr_e);
