...
<center><h2 >LENGKAPI DATA</center> </h2>
...
<body>
    <div class="card-body">
        ...
        <form  action="/tr_candidates/isi_kandidat" method="post" enctype="multipart/form-data">
          @if (session('success'))
    ...
    <div class="row">
        <div class="col-12 col-md-12">
          <div class="form-group">
              ...
              <select name= "CekCV" class="form-control">
    ...
    <div class="col-12 col-md-6">
      <div class="form-group">
          <label for="">Posisi Yang Dilamar *</label>
            <input class="form-control" type="text" name="Position_aplly1" required>
      </div>
    </div>


                  <input type="hidden" name="Ktp"  id="" class="form-control"  value="{{ $Tr_report_hrd_main_code }}">
                  <input type="hidden" name="no_sim"  id="" class="form-control" value="0" required>
                  <input type="hidden" name="type_sim"  id="" class="form-control" value="Tidak Memiliki SIM" required>
                  <input type="hidden" name="CityBirth"  id="" class="form-control" value="-" required>
                  <input type="hidden" name="status"  id="" class="form-control" value="-" required>
                  <input type="hidden" name="agama"  id="" class="form-control" value="-" required>
                  <input type="hidden" name="riwayat_penyakit"  id="" class="form-control" value="-" required>
                  <input class="form-control" readonly=readonly name="tanggal" type="hidden" value="{{Carbon\Carbon::now()->format('d-m-Y')}}" />
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="Perusahaan"  value="-">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="Posisi"  value="-">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="Gaji"  value="0">
    ...
    {{--  <h5 for=""><input type="checkbox" name="otherss" value="Riwayat Pendidikan">&nbsp;Pendidikan Terakhir</h5>  --}}
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jenjang"  value="-">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sekolah"  value="-">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jurusan" value="-">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="pengajuan_gaji"  >
                </div>
            </div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
                ...
                <input class="form-control" type="hidden" name="tanggal_ketesediaan" value="2022-01-01" id="datetime" required>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    <label for="">Gaji yang diharapkan *</label>
                    <input type="text" name="pengajuan_gaji" id="currency-field" class="form-control"  value="0" data-type="currency" required>
                </div>
            </div>
            </div>
            <div class="col-12 col-md-4">
