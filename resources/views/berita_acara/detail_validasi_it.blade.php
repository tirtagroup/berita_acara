...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Approval IT</h4>
...
<div class="card-body">
  ...
  <form  action="/detail_validasi_it/{{$main_ba->Tr_BA_Main_Code }}" method="post" enctype="multipart/form-data">
@csrf
<div class="row">
  <div class="col">
        ...
        <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
          <div class="row g-3">
             <div class="col-md-6">
              ...
              <div class="col-md-12">
                <label class="form-label" for="collapsible-phone">Note BA</label>
