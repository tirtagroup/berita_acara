...
<div class="container mt-2">
    ...
    <div class="row">
        ...
        <div class="col-md-12 card-header text-center font-weight-bold">
          <h2>Approval Manager Operasional</h2>
        </div>
        <div class="col-md-12">
            <table id="dataTable4" class="display" style="width:100%">
              ...
              <tbody>
                @foreach ($main_ba as $ba)
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_validasi_mngr/{{ $ba->Tr_BA_Main_Code }}">{{ $ba->Tr_BA_Main_Code }}</a> </td>
