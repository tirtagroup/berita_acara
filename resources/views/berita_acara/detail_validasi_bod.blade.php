...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Approval BOD</h4>
...
<form  action="/detail_validasi_bod/{{$main_ba->Tr_BA_Main_Code }}" method="post" enctype="multipart/form-data">
@csrf
<div class="row">
  <div class="col">
    ...
    <div class="accordion-body">
        ...
        <div class="container">
          <div class="col-md-12">
            ...
            <input type="text" name="username5" value="{{$user->username }}" id="collapsible-fullname" class="form-control" readonly required/>
          </div>
          <div class="col-md-12">
            <label class="form-label" for="collapsible-fullname">Note</label>
            <input type="text" name="note5" placeholder="Enter Note" id="collapsible-fullname" class="form-control" required/>
          </div>
        </div>
