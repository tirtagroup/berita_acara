...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Approval Manager Operasional</h4>
...
<div class="card-body">
  ...
  <form  action="/detail_validasi_mngr/{{$main_ba->Tr_BA_Main_Code }}" method="post" enctype="multipart/form-data">
@csrf
<div class="row">
  <div class="col">
