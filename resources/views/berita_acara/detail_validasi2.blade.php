...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Approval HRD</h4>
...
<form  action="/detail_validasi2/{{$main_ba_new->Tr_BA_Main_Code }}" method="post" enctype="multipart/form-data">
@csrf
<div class="row">
  <div class="col">
          ...
          <div class="row g-3">
             <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" value="{{$main_ba_new->Ms_Emp_Code }}" id="collapsible-fullname" class="form-control" readonly/>
              </div>
              <div class="col-md-6">
             ...
             <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" value="{{$main_ba_new->MS_Detail_Kasus }}" id="collapsible-fullname" class="form-control" readonly/>
              </div>
              <div class="col-md-12">
                <label class="form-label" for="collapsible-phone">Note</label>
                <input type="text" value="{{$main_ba_new->BA_Desc }}" id="collapsible-fullname" class="form-control" readonly/>
              </div>
              <center>
                  <h3>
                    kronologi
