...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Approval Spv</h4>
...
<form  action="/detail_validasi/{{$main_ba->Tr_BA_Main_Code }}" method="post" enctype="multipart/form-data">
@csrf
<div class="row">
  <div class="col">
             ...
             <br>
              ...
              <br>
                <table class="table table-bordered mt-4" >
                    ...
                    <tbody>
                      <tr>
                              <td>{{$tracking->approval_ba_tracking }}</td>
                              <td>{{$tracking->pic }}</td>
                              <td>{{$tracking->approval_ba_desc }}</td>
                              <td>{{$tracking->note }}</td>
                      </tr>
                    </tbody>
                    @endif
...
<div class="accordion" id="collapsibleSection">
  <div class="card accordion-item">
    ...
    <div class="accordion-body">
        ...
        <div class="container">
          <div class="col-md-12">
            <label class="form-label" for="collapsible-fullname">Validator</label>
            <input type="text" name="username2" value="{{$user->username }}" id="collapsible-fullname" class="form-control" readonly required/>
          </div>
          <div class="col-md-12">
            <label class="form-label" for="collapsible-fullname">Note</label>
            <input type="text" name="note2" placeholder="Enter Note" id="collapsible-fullname" class="form-control"/>
          </div>
        </div>
