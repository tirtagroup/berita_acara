  ...
  <div class="col">
            ...
            <div class="container">   
              <table class="table table-bordered" id="dynamicTable">  
                  ...
                  <tr>  
                      ...
                      <td>
                        <input type="text" name="Qty[]" placeholder="Enter Jumlah" class="form-control" />
                      </td>   
                  </tr>  
                  ...
                  <tr>  
                      ...
                      <td><input type="text" name="Qty[]" placeholder="Enter Jumlah" class="form-control" /></td>   
                  </tr>
                  ...
                  <div class="pure-g">
                    ...
                    <table class="table table-bordered" id="journal-entrees">  
                          ...
                          <tr class='entree-row'>
                            ...
                            <td>										
                              <input name="Nama_kandidat[]" class="row-input-group"  type="text"   />
                            </td>
                            <td>
                              <input  name="Telepon[]" class="row-input-group"  type="number"   />
                            </td>
                            <td>
    ...
    <script>
        ...
        function newRow() {
          ...
          var credit_in = '<td><input  onkeyUp="update_in(\'credit_in\');" name="Nama_kandidat[]" class="row-input-group"  type="text"  ></td>';
          var debit_in = '<td><input   onkeyUp="update_in(\'debit_in\');" name="Telepon[]" class="row-input-group"  type="text"  ></td>';
