...
<div class="row">
        <div class="panel panel-primary filterable">
            <table class="table" id="dataTable">
              ...
              <thead>
                <tr class="filters">
                    <th><input type="text" class="form-control" placeholder="Jabatan" ></th>
                    <th><input type="date" class="form-control" placeholder="Tanggal" ></th>
                    <th><input type="text" class="form-control" placeholder="Media" ></th>
