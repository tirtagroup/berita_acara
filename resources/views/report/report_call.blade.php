...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Call</h4>
  ...
  <div class="col">
          ...
          <div class="row g-3">
             <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                <input type="text" name="Ms_ReportType_Code" id="collapsible-fullname" class="form-control" value="Call" readonly />
              </div>
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input class="form-control"  type="date" name="Date_Call" value="{{Carbon\Carbon::now()->format('Y-m-d')}}" />
                </div>

                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Call PT. HGS</label>
                  <input type="number" name="Total_Call_HGS" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Call PT. TGU</label>
                  <input type="number" name="Total_Call_TGU" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Call PT. TGF</label>
                  <input type="number" name="Total_Call_TGF" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="accordion" id="collapsibleSection">
      <div class="card accordion-item">
        <h2 class="accordion-header" id="headingDeliveryOptions">
          <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseDeliveryOptions" aria-expanded="false" aria-controls="collapseDeliveryOptions">Call</button>
        </h2>
                  ...
                  <div class="pure-g">
                    ...
                    <table class="table table-bordered" id="journal-entrees">
                          ...
                          <tr class='entree-row'>
                            ...
                            <td>
                              <input name="Nama_kandidat[]" class="form-control"  type="text"   required/>
                            </td>
                            <td>
                            ...
                            <td>
                              <!-- <input  name="Telepon[]" class="row-input-group"  type="number"   required/> -->
                              <input name="Telepon[]" type="text" id="basic-default-phone" class="form-control phone-mask"  required/>
                            </td>
                            <td>
    ...
    <script>
        ...
        function newRow() {
          ...
          $(".row-body").append(tr_s+debit_ins+account_in_s+select_account+select_account_e+debit_in+account_in_a+credit_in+memo_in+remove_button+tr_e+tr_btn_s+add_button+tr_e);
