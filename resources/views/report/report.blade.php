...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Opening Lowongan</h4>
  ...
  <div class="col">
        ...
        <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
          <div class="row g-3">
             <div class="col-md-4">
                ...
                <input type="text" name="Ms_User_Code" id="collapsible-fullname" class="form-control" placeholder="Operator" value="{{ $user->name }}" readonly/>
              </div>
              <div class="col-md-4">
                ...
                <!--</select>-->
                <input type="text" name="ms_divisi" id="collapsible-fullname" class="form-control" placeholder="Operator" value="{{ $user->ms_divisi }}" readonly/>
              </div>
              <div class="col-md-4">
                <label class="form-label" for="collapsible-fullname">Type Report</label>
                <input type="text" name="Ms_ReportType_Code" id="collapsible-fullname" class="form-control" value="Opening Lowongan" readonly />
              </div>
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Tanggal Lowongan</label>
                  <input class="form-control"  type="date" name="Date_lowongan" value="{{Carbon\Carbon::now()->format('Y-m-d')}}" />
                </div>

                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Opening PT. HGS</label>
                  <input type="number" name="Total_opening_HGS" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Opening PT. TGU</label>
                  <input type="number" name="Total_opening_TGU" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
                <div class="col-md-4">
                  <label class="form-label" for="collapsible-phone">Total Opening PT. TGF</label>
                  <input type="number" name="Total_opening_TGF" id="collapsible-fullname" class="form-control" placeholder="0" required/>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <tr>
                      ...
                      <th>Jumlah</th>
                          ...
                          <tr class='entree-row'>
                            ...
                            <td>
                              <input type="text" name="Qty[]" placeholder="Enter Jumlah" class="form-control" required/>
                            </td>
                          </tr>
                          <tr class="button-row">
    ...
    <script>
        ...
        function newRow() {
          ...
          $(".row-body").append(tr_s+credit_in+account_in_s+select_account+select_account_e+debit_in+memo_in+remove_button+tr_e+tr_btn_s+add_button+tr_e);
