      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="trust" <?php if($row->mengarahkan_value == $i){ echo "checked";}else{ echo "disabled='disabled'";} ?> />
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" value="{{ $row->mengarahkan_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">         
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="drive" <?php if($row->problem_solving_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="drive_comment" value="{{ $row->problem_solving_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="inisiative" <?php if($row->planning_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="inisiatif_comment" value="{{ $row->planning_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="Reliable" <?php if($row->analisa_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="reliable_comment" value="{{ $row->analisa_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="resluts" <?php if($row->kualitas_komunikasi_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="result_comment" value="{{ $row->kualitas_komunikasi_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          <span  style="margin-left: .5rem;">{{ $row->mengarahkan_value+$row->problem_solving_value+$row->planning_value+$row->analisa_value+$row->kualitas_komunikasi_value }}</span>
        </div>
        <div class="col-sm-5">         
        </div>             
      </div>
...
<form action="/asasmen/save_leadership_spv" method="POST" enctype="multipart/form-data">
    @csrf    
  ...
  <div class="card">
      ...
      <div class="row g-3 p-3">
                ...
                <input type="hidden" name="Ms_type_asses" id="collapsible-fullname" class="form-control" value="Leadership 2" />
