...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Form Asassment Leadership 2</h4>
{{--  <form  action="/asasmen/detail_employee2" method="post" enctype="multipart/form-data">  --}}
  <form  action="/asasmen/detail_leadership_employee2" method="post" enctype="multipart/form-data">
                  ...
                  <tbody class="row-body">
                    ...
                    @foreach ($basic1 as $data)
                      <tr class='entree-row'>
                          ...
                          <td>
                            <input class="form-control" type="number" autoComplete="on"  value="{{ $data->arahan}}" readonly />
                          ...
                          <td>
                            <input class="form-control" type="number" autoComplete="on" value="{{ $data->solving}}" readonly />
                          ...
                          <td>
                            <input class="form-control" type="number" autoComplete="on" value="{{ $data->planing}}" readonly />
                          ...
                          <td>
                            <input class="form-control" type="number" autoComplete="on" value="{{ $data->analisa}}" readonly />
                          ...
                          <td>
                            <input class="form-control" type="number" autoComplete="on" value="{{ $data->komunikasi}}" readonly />
