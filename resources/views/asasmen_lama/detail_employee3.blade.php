...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Form Asassment Basic 3</h4>
  <form  action="/asasmen/detail_employee3/{{$code}}" method="post" enctype="multipart/form-data">
...
<form>
  {{--  <form  action="/asasmen/detail_employee2" method="post" enctype="multipart/form-data">  --}}
    <form  action="/asasmen/detail_employee3/{Tr_Job_Assesment_all_code}" method="post" enctype="multipart/form-data">
@csrf
