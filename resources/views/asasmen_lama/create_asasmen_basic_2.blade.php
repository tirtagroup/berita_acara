...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Form Asassment Basic 2</h4>
<form  action="/asasmen/asasmen_basic_detail2" method="post" enctype="multipart/form-data">
  @if (session('success'))
