            ...
            <table id="dataTable4" class="display" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <a href="/asasmen/detail_employee3/{{ $tipe->Tr_Job_Assesment_all_code }}" class="btn btn-warning edit" data-id="{{ $tipe->Tr_Job_Assesment_all_code }}">Proccess</a>
                    </td>
                </tr>
                @endforeach
              </tbody>
