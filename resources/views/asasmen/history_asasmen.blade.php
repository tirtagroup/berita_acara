        ...
        @foreach($employee as $user)
            <tr>
              <td>{{date_format(date_create($user->created_at),"Y-m-d") }}</td>
                <td>{{ $user->Tr_Review_EmpPeriod_Code_h }}</td>
                <td>{{ $user->Ms_emp_code }}</td>
                <td>{{ $user->Ms_Emp_Div }}</td>
                <td>{{ $user->Ms_Reviewer_Code }}</td>
                <td>{{ $user->ms_periode }}</td>
                <td>
                  @if (in_array(Auth::user()->sub_divisi, ['Manager Finance', 'General Manager', 'HR', 'BOD', 'Manager Operasional', 'Supervisor']))
                      <a href="/print_history/{{$user->Tr_Review_EmpPeriod_Code_h}}" class="btn btn-outline-success">
