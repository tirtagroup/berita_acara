...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Form Asassment Discipline</h4>
            ...
            @foreach($tr_emp_assesment as $row)
                ...
                <div class="col-md-6">
                  <label class="form-label" for="collapsible-fullname">Assesor</label>
                    <input type="hidden" name="Ms_Emp_Assessor_Code" id="collapsible-fullname" class="form-control" value="{{ $row->Ms_Emp_Assessor_Code  }}" readonly required/>
                    <input type="text" class="form-control" value="{{ $row->name  }}" readonly/> </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label class="form-label" for="collapsible-fullname">Nama Staff</label>
                    {{-- <select class="js-states form-control" id="single" name="Ms_Emp_Code" >
                      ...
                      <input type="text" class="form-control" value="{{ $row->emp_name  }}" readonly/></div>
                <div class="col-md-6">
...
@foreach($tr_emp_assesment as $row)
    ...
    <div class="row">
      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Absensi</label>
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="trust" <?php if($row->absensi_value == $i){ echo "checked";}else{ echo "disabled='disabled'";} ?> />
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" value="{{ $row->absensi_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Report</label>
        <div class="col-sm-5">         
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="drive" <?php if($row->report_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="drive_comment" value="{{ $row->report_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Kerajinan</label>
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="{{ $i }}"  data-type="inisiative" <?php if($row->kerajinan_value == $i){ echo "checked";}else{ echo "disabled='disabled'";}  ?> />
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="inisiatif_comment" value="{{ $row->kerajinan_comment }}" readonly>             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          <span  style="margin-left: .5rem;">{{ $row->absensi_value+$row->report_value+$row->kerajinan_value }}</span>
        </div>
        <div class="col-sm-5">         
        </div>             
      </div>
    ...
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="absensi_value_{{ $i }}" name="absensi_value" value="{{ $i }}"  data-type="trust" onclick="updateTotal()">
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="absensi_comment">             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">         
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="report_value_{{ $i }}" name="report_value" value="{{ $i }}"  data-type="drive" onclick="updateTotal()">
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="report_comment">             
        </div>             
      </div>
    </div>
    <div class="row">
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          @for($i = 1; $i <= 5; $i++)
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="kerajinan_value_{{ $i }}" name="kerajinan_value" value="{{ $i }}"  data-type="inisiative" onclick="updateTotal()">
            <label class="form-check-label" for="inlineRadio1">{{ $i }}</label>
          </div>
          @endfor
        </div>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Enter Comment" name="kerajinan_comment">             
        </div>             
      </div>
    </div>
    <div class="row">
...
<form action="/asasmen/save_discipline_spv" method="POST" enctype="multipart/form-data">
    @csrf    
  ...
  <div class="card">
      ...
      <div class="row g-3 p-3">
                ...
                <input type="hidden" name="Ms_type_asses" id="collapsible-fullname" class="form-control" value="Discipline 2" />
                <input type="hidden" name="Ms_record_asses" id="collapsible-fullname" class="form-control" value="Supervisor" />
    </div>
...
<div class="p-3">
  <br>
  <br><center><h2>Rating Create Supervisor</h2></center>
  <div class="row">
    <div class="mb-3 row">
      <label for="inputPassword" class="col-sm-2 col-form-label">Absensi</label>
      <div class="col-sm-5">
...
$(document).on('click', '.removeDivBtn', function () {
  ...
  $("#repeatDivBtn").data("increment", $inc-1);
      ...
      function updateTotal() {
        ...
        const trustValue = parseInt($('input[name="absensi_value"]:checked').val()) || 0;
        const driveValue = parseInt($('input[name="report_value"]:checked').val()) || 0;
        const inisiatValue = parseInt($('input[name="kerajinan_value"]:checked').val()) || 0;

        // Menghitung total nilai
        totalValue = trustValue + driveValue + inisiatValue;
        ...
        if (totalValue < 10) {
          ...
          $('#total-score').css('color', 'black'); // atau warna lain sesuai kebutuhan
        }
      }
    </script>
