...
<table>
 {{--  <h5>PROGRESS </h5>                --}}
                ...
                <table>
                    <tr>
                        <td style=" font-weight: bold;">Shortlist           </td>
                        <td>:                                               </td>
                        <td>
                                @if($header['CekShorlist'] == True)
                                Sudah Shortlist
                                @else
                                Belum Shortlist
                                @endif
                        ...
                        <td>:                                               </td>
                        <td>
                                @if($header['status_shortlist'] == 1)
                                Lolos Ke Tahap Berikutnya
                                @elseif($header['status_shortlist'] == 2)
                                Tidak Lolos Ke Tahap Berikutnya
                                @else
                                Belum Shortlist
                                @endif
                        </td>
                    ...
                    <tr>
                        <td style=" font-weight: bold;">Panggil           </td>
                        <td>:                                               </td>
                        <td>
                        ...
                        <td>:                                               </td>
                        <td>
                                @if($header['Cek_Sambung'] == 1)
                                Terhubung
                                @elseif($header['Cek_Sambung'] == 0)
                                Tidak Terhubung
                                @else
                                Belum Dipanggil
                                @endif
                    ...
                    <tr>
                        <td style=" font-weight: bold;">Interview           </td>
                        <td>:                                               </td>
                        <td>
                        ...
                        <td>:                                               </td>
                        <td>
                                @if($header['status_interview'] == 1)
                                Lolos Interview
                                @elseif($header['status_interview'] == 2)
                                Tidak Lolos Interview
                                @else
                                Belum Interview
                                @endif
                        </td>
                        <td style=" font-weight: bold;">PIC Interview             </td>
                        <td>:                                               </td>
  ...
  {{ csrf_field() }}
            <table>
                ...
                <tr>
                  ...
                  <td>:                                                 </td>
                  <td> {{$header['Ktp']}}                               </td>
                  <td style=" font-weight: bold;">Masa Berlaku KTP                  </td>
                  <td>:                                                 </td>
                  <td> {{$header['masa_berlaku_ktp']  }}                           </td>
              </tr>
              <tr>
                <td style=" font-weight: bold;">Alamat KTP               </td>
                <td>:                                                 </td>
                <td> {{$header['alamat_ktp']}}                               </td>
            ...
            <tr>
              <td style=" font-weight: bold;">Masa Berlaku SIM            </td>
              <td>:                                                     </td>
              <td> {{$header['masa_berlaku_sim']}}                             </td>
...
<table rules="all" border="1" >
  ...
  <tr>
    ...
    <td>Rp. {{   $pengalaman_det2['Gaji2']    }} </td>
  ...
  <tr>
    ...
    <td>Rp. {{   $pengalaman_det3['Gaji3']    }} </td>
...
<table rules="all" border="1" >
  ...
  <tr>
    ...
    <td>{{   $keluarga['no_hp_aktif2']}} </td>
    <td>{{   $keluarga['alamat2']}} </td>
  </tr>
</table>
<br>
<br>
