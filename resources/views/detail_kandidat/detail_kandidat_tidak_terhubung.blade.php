...
<body>
  <h5 >KANDIDAT TIDAK TERHUBUNG</h5>
  ...
  <center>
    ...
    <br>
            <table>
                ...
                <tr>
                    <td style=" font-weight: bold;">Jadwal Interview               </td>
                    <td>:                                               </td>
                    <td> {{$header['jadwal_interview']}}                            </td>
                    <td style=" font-weight: bold;">Alasan Tidak Terhubung               </td>
                    <td>:                                               </td>
                    <td> {{$header['alasan_sambung']  }}                     </td>
                </tr>
            </table>
            <h5 >DETAIL KANDIDAT TIDAK TERHUBUNG</h5>
            <table>
                <tr>
