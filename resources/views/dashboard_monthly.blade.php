...
var labels = [@foreach($total_ba_monthly_by_location as $wine) @php echo "'".$wine->rec_areacode."'"."," @endphp @endforeach];

var values = [@foreach($total_ba_monthly_by_location as $wine) @php echo $wine->total_ba.","; @endphp @endforeach];
...
<script>
  ...
  var labels = ['',@foreach($total_ba_monthly_by_div as $wine) @if($wine->Ms_Emp_Div == '') @php echo "'"."Driver"."'"."," @endphp @else @php echo "'".$wine->Ms_Emp_Div."'"."," @endphp @endif @endforeach];

  var values = [0,@foreach($total_ba_monthly_by_div as $wine) @php echo $wine->total_ba.","; @endphp @endforeach];
...
<center>
  <h5 class="m-0 me-2">Monthly BA By Divisi</h5>
</center>
...
<div class="row">
  <div class="col-lg-4 col-md-4 order-1">
    <center>
    <h4 class="m-0 me-2" style="background-color: #5f4bdd; color: #fff; padding: 10px; text-align: center;">Monthly Top 10 PIC </h4>
    </center>
    <br>
    <div class="row">
          ...
          <div class="card-body">
            ...
            <!--<h4 class="card-title mb-2">{{ $by_pic->total_ba }}</h4>-->
                ...
                <h6 class="card-title mb-2">{{ $by_pic->Ms_Emp_Div }}</h6>                
                 @else
                <span class="fw-semibold d-block mb-1"><a  href="/detail_pelaku_month/{{$by_pic->Ms_Emp_Code}}" target="blank">{{ $by_pic->Ms_Emp_Code }}</a><small class="text-danger fw-semibold">({{  $by_pic->total_ba }})</small></span>
                <h6 class="card-title mb-2">{{ $by_pic->Ms_Emp_Div }}</h6>
                 @endif            
            @endforeach
          </div>
...
<div class="row">
  ...
  <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
    <center>
    <h4 class="m-0 me-2" style="background-color: #5f4bdd; color: #fff; padding: 10px; text-align: center;">Monthly BA By Category</h4>
    </center>
    <br>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div class="d-flex flex-column align-items-center gap-1">
            <h5 class="text-warning fw-semibold">Total BA This Month = {{ $total_ba_weeks }}</h5>
          </div>
          <div id=""></div>
        </div>
        <ul class="p-0 m-0">
           <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                 @foreach ($total_ba_weekly as $ba_pelanggaran1)
                  <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/pelanggaran">{{ $ba_pelanggaran1->total_ba_pelanggaran_sop }}</a></small>
                  @endforeach
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                @foreach ($total_ba_weekly as $ba_pelanggaran1)
                <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/perubahan">{{ $ba_pelanggaran1->total_ba_perubahan_sop }}</a></small>
                @endforeach
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                @foreach ($total_ba_weekly as $ba_pelanggaran1)
                <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/kehilangankerusakan">{{ $ba_pelanggaran1->total_ba_kehilangan_kerusakan_aset }}</a></small>
                @endforeach
              </div>
            </div>
          </li>
           <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                @foreach ($total_ba_weekly as $ba_pelanggaran1)
                <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/pembelian">{{ $ba_pelanggaran1->total_ba_pembelian }}</a></small>
                @endforeach
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                 @foreach ($total_ba_weekly as $ba_pelanggaran1)
                  <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/laka">{{ $ba_pelanggaran1->total_ba_laka }}</a></small>
                  @endforeach
              </div>
            </div>
          </li>
          <li class="d-flex mb-4 pb-1">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                @foreach ($total_ba_weekly as $ba_pelanggaran1)
                <small class="fw-semibold"><a class="underlineHover" href="/viewkategorimonth/revisi">{{ $ba_pelanggaran1->total_ba_kesalahan_revisi }}</a></small>
                @endforeach
              </div>
            </div>
          </li>
  ...
  <div class="col-md-4 col-lg-4 order-1 mb-4">
    <center>
    <h4 class="m-0 me-2" style="background-color: #5f4bdd; color: #fff; padding: 10px; text-align: center;">Monthly BA By Location</h4>
    </center>
    <br>
    <div class="card">
