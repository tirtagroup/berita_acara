...
<div id="card" class="container">
    ...
    <div class="logo"><img src="https://reportstaff.tirta-group.com/upload/logohgs.jpg" style="width:100px;height:70px;" > </div>
</center>
    ...
    {{--  <h5 for=""><input type="checkbox" name="otherss" value="Riwayat Pendidikan">&nbsp;Pendidikan Terakhir</h5>  --}}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <option value="MT Transport/Logistic" style="weight:50px">    > MT Transport/Logistic</option>
