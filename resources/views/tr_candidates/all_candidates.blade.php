...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Semua Kandidat</h4>
          ...
          <a href="/cv_jobportal" class="button">Cv JobPortal</a>
        </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td data-table-header="Title">
                      ...
                      @else --}}
                        <a class="underlineHover" href="/detail_kandidat/detail_kandidat_progress/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a>
                      {{-- @endif --}}
                    </td>
