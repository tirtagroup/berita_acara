...
<center><h2 >LENGKAPI DATA DARI ERIKA </center> </h2>
...
<body>
    <div class="card-body">
        ...
        <form  action="/tr_candidates/validasi_jobportal" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="Name" id="" class="form-control" value="{{ $header->full_name }}" >
            </div>
        </div>
        <br>
        <div class="col-12 col-md-12">
            <div class="form-group">
                <label for="">No. Ktp *</label>
                  <input type="text" name="Ktp"  id="" class="form-control" value="{{ $ktp_otomatis }}" >
            </div>
        </div>
        <div class="col-12 col-md-12">
            <div class="form-group">
                <label for="">Alamat / Domisili *</label>
                <input type="text" name="domisili"  id="" class="form-control" value="{{ $header->address }}" >
            </div>
        </div>
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="">No. SIM *</label>
                <input type="number" name="no_sim"  id="" class="form-control" value="0" required>
            </div>
        </div>
        <div class="col-12 col-md-6">
            <div class="form-group">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="CityBirth"  id="" class="form-control" value="-">
            </div>
        </div>
        <div class="col-12 col-md-6">
            <div class="form-group">
                <label for="">Tanggal lahir *</label>
                <input class="form-control" type="text" name="Birthdate"  value="{{ $formattedDate2 }}">
            </div>
        </div>
        <div class="col-12 col-md-6">
                <label for="" >Status </label>
                  <select name = "status" class="form-control" >
                      <option value="Lajang" style="weight:50px">Lajang</option>
                      <option value="Menikah" style="weight:50px">Menikah</option>
                      <option value="Cerai Hidup" style="weight:50px">Cerai Hidup</option>
                      <option value="Cerai Mati" style="weight:50px">Cerai Mati</option>
                  </select>
        </div>
        <div class="col-12 col-md-6">
            <label for="" >Jenis Kelamin</label>
            <input class="form-control" type="text" name="jenis_kelamin"  value="{{ $header->gender }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="agama"  id="" class="form-control" value="-">
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="Handphone"  value="{{ $header->cell_phone }}">
        ...
        <div class="col-12 col-md-12">
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input class="form-control" type="text" name="Email"  value="{{ $header->email }}">
        ...
        <div class="col-12 col-md-12">
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="riwayat_penyakit"  id="" class="form-control" value="-">
                    <div class="input-group-append">
                        <!-- <span class="input-group-text">@ex.com</span> -->
                    </div>
                </div>
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            <input class="form-control" type="date" name="tanggal"  value="{{ $formattedDate }}">
    ...
    <h5 for=""><input type="checkbox" onclick="myFunction2()">&nbsp;Pengalaman Kerja Terakhir</h5>
                        {{--  <fieldset  id='TextBoxesGroup'class="others">  --}}
                      <fieldset  id='myDIV2'class="others">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                    <div id="inputFormRow">
                                <div class="form-group">
                                    <label for="">*1. Nama Perusahaan</label>
                                    <input class="form-control" type="text" name="Perusahaan"  value="{{ $header->last_company }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="Posisi"  value="{{ $header->last_job }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Lama_kerja"  id="" class="form-control" value="-">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="Gaji"  value="{{ $header->current_sallary }}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="number"  id="" class="form-control" value="0">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alasan_keluar"  id="" class="form-control" value="-">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="komentar"  id="" class="form-control" value="-">
                    ...
                    <h5 for=""><input type="checkbox" name="others" onclick="checkMe(this.checked);" style="color:red;">&nbsp;Tambah Pengalaman Kerja</h5>

                    {{--  <fieldset  id='TextBoxesGroup'class="others" id="myDIV2">  --}}
                    <fieldset  class="others" id="divcheck" style="display:none;">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                    <div id="inputFormRow">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">Gaji </label>
                                    <input type="text" name="Gaji2" id="rupiah2" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                    ...
                    <h5 for=""><input type="checkbox" name="otherss" onclick="checkMe2(this.checked);">&nbsp;Tambah Pengalaman Kerja</h5>
                    </fieldset>
                    <br>

                    {{--  <fieldset  id='TextBoxesGroup'class="otherss">  --}}
                    <fieldset  class="otherss" id="divcheck2" style="display:none;">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                    <div id="inputFormRow">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">Gaji </label>
                                    <input type="text" name="Gaji3" id="rupiah3" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
    ...
    {{--  <h5 for=""><input type="checkbox" name="otherss" value="Riwayat Pendidikan">&nbsp;Pendidikan Terakhir</h5>  --}}
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jenjang"  value="{{ $header->last_education }}">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sekolah"  value="{{ $header->last_school	 }}">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jurusan"  value="{{ $header->last_major	 }}">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tahunmasuk" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Tahun Lulus</label>
                            <input type="text" name="tahunlulus" id="rupiah"  value="-"  class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Alamat Sekolah / Universitas </label>
                            <input type="text" name="alamat" id="" value="-"  class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="" >Nilai Rata-Rata / IPK</label>
                            <input class="form-control" type="text" name="ipk"  value="{{ $header->last_gpa }}">
                            {{-- <input type="text" name="ipk" id="" value="-"  class="form-control" required> --}}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Nama_organisasi" id="" value="-" class="form-control">
                        </div>
                    </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Jabatan" id=""  value="-" class="form-control" >
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Periode</label>
                            <input type="text" name="Periode" id="rupiah" value="-" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <h5 for=""><input type="checkbox" name="othersss" value="Pengalaman Organisasi / Pelatihan" onclick="checkMe3(this.checked);">&nbsp;Tambah Organisasi / Pelatihan</h5>
            {{--  <fieldset  id='TextBoxesGroup'class="othersss">  --}}
            <fieldset  id="divcheck3" style="display:none;" class="othersss">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div id="inputFormRow">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Skill" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                    </div>
                    <div class="col-12 col-md-6">
            ...
            <h5 for=""><input type="checkbox" name="otherssss" value="Skill" onclick="checkMe4(this.checked);">&nbsp;Tambah Skill</h5>
            <fieldset  id="divcheck4" style="display:none;">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div id="inputFormRow">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="nickname" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <h5 for=""><input type="checkbox" name="othersssss" value="Social Media" onclick="checkMe5(this.checked);">&nbsp;Tambah Media Sosial</h5>
             {{--  <fieldset  id='TextBoxesGroup'class="othersssss">  --}}
             <fieldset  id="divcheck5" style="display:none;" class="othersssss">
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div id="inputFormRow">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="namanya" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Pendidikan Terakhir</label>
                            <input type="text" name="pendidikan" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Pekerjaan</label>
                            <input type="text" name="pekerjaan" id="" value="-" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="">Tempat Berkerja</label>
                            <input type="text" name="tempat" id="" value="-"class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <h5 for=""><input type="checkbox" name="otherssssss" value="Riwayat Keluarga" onclick="checkMe6(this.checked);">&nbsp;Tambah Hubungan Keluarga</h5>
            {{--  <fieldset  id='TextBoxesGroup'class="otherssssss">  --}}
            <fieldset  id="divcheck6" style="display:none;" class="otherssssss">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div id="inputFormRow">
                        <div class="form-group">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    {{-- <input type="text" name="pengajuan_gaji" id='rupiah4' class="form-control" > --}}
                    <input class="form-control" type="text" name="pengajuan_gaji"  value="{{ $header->expected_sallary }}">
                </div>
            </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="info_lowongan"  id="" class="form-control" value="Erika">
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="">Posisi Yang Dilamar Pertama *</label>
                      <input class="form-control" type="text" name="Position_aplly1"  value="{{ $header->applied_position }}">
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="">Posisi Yang Dilamar Kedua *</label>
                      <input type="text" name="Position_aplly2"  id="" class="form-control" value="-">
                    </select>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="">Area Yang Diminati</label>
                      <input type="text" name="area_minat"  id="" class="form-control" value="-">
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="">Siap Di Tempatkan Sesuai Kebutuhan Perusahaan? * </label>
            ...
            <div class="col-12 col-md-12">
                    ...
                    <input type="hidden" name="layak" value= "-" class="form-control">
            ...
            <br>
            <center>
                <button class="btn btn-success" type="submit" name="send">Validasi</button>
            </center>
        </div>
        <br>
        <center>
