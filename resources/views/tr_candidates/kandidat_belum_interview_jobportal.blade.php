...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Kandidat Belum Interview</h4>
   <li class="nav-item dropdown">
          ...
          <a href="/tr_candidates/kandidat_belum_interview" class="button">Cv Software</a>
</div>
    <hr>
<div class="row">
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat_belum_interview_jobportal/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
