...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Kandidat Belum Shortlist</h4>
   <li class="nav-item dropdown">
          ...
          <a href="/kandidat_belum_short_jobportal" class="button">Cv JobPortal</a>
</div>
    <hr>
<div class="row">
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat/detail_kandidat_belum_short/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
