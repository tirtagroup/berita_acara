...
<div id="card" class="container">
    ...
    <div class="logo"><img src="upload/logohgs.jpg" style="width:100px;height:70px;" > </div>
</center>
...
{{--  <h5><input type="checkbox"name="other" onclick="myFunction()"> &nbsp;Data Pribadi </h5>  --}}
{{--  <button style="font-size:17px" onclick="myFunction()">Data Pribadi <i class="fa fa-plus"></i></button>  --}}
    <div class="card-body">
        @if (count($errors) > 0)
        ...
        @endif
        <form  action="/tr_candidates/candidate_apply_driver" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
              ...
              <input type="text" name="nama_panggilan" id="" class="form-control" required>
          </div>
      </div>
        <br>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
              <label for="">Masa Berlaku Ktp *</label>
              <input type="text" name="masa_berlaku_ktp"  id="" class="form-control"  required>
          </div>
        </div>
      <div class="col-12 col-md-6">
        <div class="form-group">
            <label for="">Alamat Ktp *</label>
            <input type="text" name="alamat_ktp"  id="" class="form-control" required>
        </div>
    </div>
        <div class="col-12 col-md-6">
            <div class="form-group">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
              <label for="">Masa Berlaku SIM *</label>
              <input type="text" name="masa_berlaku_sim"  id="" class="form-control"  required>
          </div>
        </div>
        <div class="col-12 col-md-6">
            <div class="form-group">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
              ...
              <input type="text" name="umur"  id="" class="form-control" required>
          </div>
      </div>
        <div class="col-12 col-md-6">
          <div class="form-group">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
            ...
            <select  name = "jenis_kelamin" class="form-control" >
                <option value="Male" style="weight:50px">Laki - Laki</option>
                <option value="Female" style="weight:50px">Perempuan</option>
            </select>
        </div>
      </div>
        <div class="col-12 col-md-6">
          <div class="form-group">
              ...
              <input type="text" name="nama_ibu" id="" class="form-control"  required>
          </div>
      </div>
        <div class="col-12 col-md-6">
        <div class="form-group">
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            <label for="">Tanggal Melamar</label>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_hp_aktif" id="" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="form-group">
            ...
            <fieldset  id="divcheck6" style="display:none;" class="otherssssss">
              <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="">*Status Hubungan</label>
                          <input type="text" name="hubungan2" id="" class="form-control" required>
                    </div>
                </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="">Nama</label>
                        <input type="text" name="namanya2" id="" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="">Pendidikan Terakhir</label>
                        <input type="text" name="pendidikan2" id="" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="">Pekerjaan</label>
                        <input type="text" name="pekerjaan2" id="" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="">Tempat Berkerja</label>
                        <input type="text" name="tempat2" id="" class="form-control" required>
                    </div>
                </div>
              <div class="col-12 col-md-6">
                <div class="form-group">
                    <label for="">No. HP Aktif</label>
                    <input type="text" name="no_hp_aktif2" id="" class="form-control" required>
                </div>
            </div>
            <div class="col-12 col-md-6">
              <div class="form-group">
                  <label for="">Alamat</label>
                  <input type="text" name="alamat2" id="" class="form-control" required>
              </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select name = "area_minat" class="form-control" >
                        <option value="Jakarta" style="weight:50px">Jakarta</option>
                        <option value="Bandung" style="weight:50px">Bandung</option>
                        <option value="Bogor" style="weight:50px">Bogor</option>
                        <option value="Subang" style="weight:50px">Subang</option>
                        <option value="Sukabumi" style="weight:50px">Sukabumi</option>
                    </select>
                </div>
            </div>
            <div class="col-12 col-md-6">
