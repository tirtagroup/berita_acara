...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Kandidat Belum Interview Ketiga</h4>
   <li class="nav-item dropdown">
          ...
          <a href="/kandidat_belum_interview_jobportal" class="button">Cv JobPortal</a>
</div>
    <hr>
<div class="row">
        <div class="panel panel-primary filterable">
            <table class="table" id="dataTable">
              ...
              <thead>
                ...
                <tbody>
                  @foreach($kandidat as $trCandidate)
                  <tr>
                    <td>{{ $trCandidate->ms_kode_interview1 }}</td>
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat/detail_kandidat_belum_interview3/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
