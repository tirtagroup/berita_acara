...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Kandidat Belum Dihubungi</h4>
   <li class="nav-item dropdown">
          ...
          <a href="/tr_candidates/kandidat_belum_dihubungi" class="button">Cv Software</a>
          {{-- <button> tes</button> --}}
</div>
            ...
            <table class="table" id="dataTable">
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat/detail_kandidat_belum_dihubungi/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
                ...
                @foreach($call as $trCandidate)
                  <tr>
                    ...
                    {{-- <td data-table-header="Title"> --}}
                      <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat/detail_kandidat_belum_dihubungi_jobportal/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
                    {{-- </td> --}}
                    <td>{{ $trCandidate->domisili }}</td>
                    <td>{{ $trCandidate->Birthdate }}</td>
                    <td>{{ $trCandidate->jenis_kelamin }}</td>
                    <td>{{ $trCandidate->Position_aplly1 }}</td>
                    <td>{{ date_format(date_create($trCandidate->created_at),"d/m/Y") }}</td>
