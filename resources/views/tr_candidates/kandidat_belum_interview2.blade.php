...
<div class="container">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Kandidat Belum Interview Kedua</h4>
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td data-table-header="Title"><a class="underlineHover" href="/detail_kandidat/detail_kandidat_belum_interview2/{{ $trCandidate->Ktp }}">{{ $trCandidate->Name }}</a> </td>
