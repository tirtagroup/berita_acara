              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="email" class="form-label">Company</label>
                    <select class="form-control" id="email" name="ms_company"  required>
                      @foreach ($ms_company as $pt)
                                <option value="{{$pt->description}}">
                              {{$pt->description}}
                      @endforeach
                    </select>
                  {{--  <input type="text" class="form-control" id="email" name="ms_company" placeholder="Enter your email" required="" />  --}}
                </div>
                <div class="mb-3">
                  <label for="email" class="form-label">Branch</label>
                    <select class="form-control" id="email" name="ms_branch"  required>
                        @foreach ($ms_branch as $branch)
                                  <option value="{{$branch->description}}">
                                {{$branch->description}}
                        @endforeach
                    </select>
                  {{--  <input type="text" class="form-control" id="email" name="ms_branch" placeholder="Enter your email" required="" />  --}}
                </div>
                <div class="mb-3">
